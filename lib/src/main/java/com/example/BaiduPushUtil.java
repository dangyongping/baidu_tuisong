...
public class BaiduPushUtil {
    public static void pushMsg(String msg,String channelId) throws PushClientException, PushServerException{
		 /*1. 创建PushKeyPair
         *用于app的合法身份认证
         *apikey和secretKey可在应用详情中获取
         */
        String apiKey = DichEnumConf.baiduPush.API_KEY;
        String secretKey = DichEnumConf.baiduPush.SECRETE_KEY;
